...
```{r growth_ms_deg, fig.height=7, fig.width=9}
...
```{r interactive_map, fig.height=7, fig.width=9}
...
```{r map_count_uni, fig.height=7, fig.width=9}
countmap <- ggplot() +
...
```{r topic_model_course_desc, fig.height=7, fig.width=9}
top_terms %>%
